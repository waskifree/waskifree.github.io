...
<html lang="en">
  ...
  <body id="about">
    ...
    <div class="top pt-3 ps-3">
      <svg class="mb-2 ms-2" xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-person-circle" viewBox="0 0 16 16">
        <path d="M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0z" />
        <path fill-rule="evenodd" d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8zm8-7a7 7 0 0 0-5.468 11.37C3.242 11.226 4.805 10 8 10s4.757 1.225 5.468 2.37A7 7 0 0 0 8 1z" />
      </svg>
      <span class="fw-bold fs-3 p-2">about</span>
    ...
    <div class="container shadow mt-1">
      <p class="fs-2 ps-3">my things</p>
      <div class="row text-center mb-3">
        <div class="col-12">
          <img class="float-start p-3 img-fluid" width="350px" src="img/aryo.jpg" alt="" />
          <p class="text-start pt-3">hello there! my name is Aryo Waskito i am from Indonesia i am 19 years old, i am an engineer, my favorite foods are made by my mother,my mbti is intj, way of my life is "based on virtue"  </p>
        </div>
      </div>
      <p class="fs-2 text-center mt-3">Gallery</p>
      <div class="row justify-content-around m-5 text-center">
        <div class="col-md-3 my-4">
          <a href="#gambar1">
            <img class="img-fluid" src="img/withfish.jpg" alt="" width="300px" />
            <p class="my-3">with a lil fish, RIP.</p>
            <div class="overlay" id="gambar1">
              ...
              <img class="img-fluid" src= "img/withfish.jpg"alt="" width="0px" />
            </div>
          </a>
        </div>
        <div class="col-md-3 my-4">
          <a href="#gambar2">
            <img class="img-fluid" src="img/intimidativeface.jpg" alt="" width="300px" />
            <p class="my-3">haaaaaa?!</p>
            <div class="overlay" id="gambar2">
              ...
              <img class="img-fluid" src="img/intimidativeface.jpg"alt="" width="0px" />
            </div>
          </a>
        </div>
        <div class="col-md-3 my-4">
          <a href="#gambar3">
            <img class="img-fluid" src="img/ancientpic.jpg" alt="" width="300px" />
            <p class="my-3">ancient pic</p>
            <div class="overlay" id="gambar3">
              ...
              <img class="img-fluid" src="img/ancientpic.jpg" alt="" width="0px" />
            </div>
          </a>
        </div>
      ...
      <div class="medsos">
        <div class="instagram">
          <a href="https://www.instagram.com/waskitoaryo" target="_blank">
