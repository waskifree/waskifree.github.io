...
<html lang="en">
  ...
  <body id="contact">
    ...
    <div class="top pt-3 ps-3">
      <svg class="mb-2 ms-2" xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-chat-right-text-fill" viewBox="0 0 16 16">
        <path
      ...
      <span class="fw-bold fs-3 p-2 mt-1">contact</span>
    ...
    <div class="container shadow mt-1">
      <div class="row">
        <div class="col-sm-6">
          <p class="fs-2 ps-3">let's talk!</p>
          <p>messege me if you wondering</p>        </div>
        <div class="col-sm-6">
          <form action="https://formspree.io/f/mlekrjar" method="POST" target="_blank">
            <div class="contact">
              ...
              <div class="mb-3">
                ...
                <textarea name="messege" class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="Messege, Criticsm, Sugestion or love letter :)"></textarea>
              </div>
